...
function ProjectItem({
  ...
  const link = (
    ...
    >
      ...
      {!rail && project.pauseReason === "budget" ? <BudgetSidebarMarker title={t("nav.projects.pausedByBudget")} /> : null}
    </NavLink>
  );
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              ...
              aria-label={t("nav.projects.openActions", { name: project.name })}
            >
          ...
          <DropdownMenuContent align="end" className="w-44">
            ...
            >
              ...
              <span>{leaving ? t("nav.projects.leaving") : t("nav.projects.leave")}</span>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
        )}
...
export function SidebarProjects() {
  ...
  const projectSortChoices = useMemo<SidebarSectionRadioChoice[]>(
    () => [
      { value: "top", label: t("nav.projects.sortTop") },
      { value: "alphabetical", label: t("nav.projects.sortAlphabetical") },
      { value: "recent", label: t("nav.projects.sortRecent") },
    ],
    [t],
  );
  ...
  return (
    <SidebarSection
      label={t("nav.projects.section")}
      collapsible={{ open, onOpenChange: setOpen }}
      headerAction={{
        ariaLabel: t("nav.projects.newProject"),
        icon: Plus,
        onClick: openNewProject,
      }}
      menu={{
        ariaLabel: t("nav.projects.sectionActions"),
        actions: [
          { type: "item", label: t("nav.projects.browse"), icon: FolderOpen, href: "/projects" },
          { type: "separator" },
        ],
        radioLabel: t("nav.projects.sort"),
