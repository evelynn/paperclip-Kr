        ...
        <div ref={overlayRef} className="relative h-full w-full">
          {highlightRects.map((rect, index) => {
            ...
            return (
              <button
                ...
                data-status={rect.status}
                data-focused={isFocused || undefined}
                aria-label={t("issueDocs.layer.openThread")}
                className={cn(
          ...
          {highlightRects.map((rect, index) =>
            rect.isTail && rect.anchorState === "stale" ? (
              <span
                ...
                title={t("issueDocs.layer.anchorMoved")}
              >
          ...
          {pendingAnchor && toolbarPosition ? (
            <div
              ...
              role="toolbar"
              aria-label={t("issueDocs.layer.selectionActions")}
            ...
            >
              <Button
                ...
                title={newCommentDisabled
                  ...
                  : t("issueDocs.layer.addCommentTitle")}
              >
                <MessageSquarePlus className="h-3.5 w-3.5" aria-hidden="true" />
                {t("issueDocs.layer.comment")}
              </Button>
            </div>
          ) : null}
        </div>
