...
export function IssueRow({
  ...
  const productivityReviewIndicator = productivityReview ? (
    <span
      ...
      title={t("issues.row.productivityReviewTitle", { label: productivityReviewTriggerLabel(productivityReview.trigger) })}
      aria-label={t("issues.row.productivityReview")}
    >
        ...
        <span className="inline-flex h-4 w-4 shrink-0 items-center justify-center self-center">
          {showUnreadDot ? (
            <button
              ...
              aria-label={t("issues.row.markAsRead")}
            >
              <span
                className={cn(
            ...
            <button
              ...
              aria-label={t("issues.row.dismiss")}
            >
...
function renderRecoveryChip(t: TFunction, action: IssueRecoveryAction, selected: boolean): ReactNode {
  ...
  return (
    <span
      ...
      title={t("issues.row.recoveryTitle", { label })}
    >
