...
export const ChatComposer = forwardRef<ChatComposerHandle, ChatComposerProps>(function ChatComposer(
  ...
  const placeholder = placeholderProp ?? t("chatThread.messagePlaceholder");
  const sendLabel = sendLabelProp ?? t("chatThread.sendMessage");
        ...
        {canAttach ? (
          <>
            ...
            <button
              ...
              aria-label={t("chatThread.attachFiles")}
              title={t("chatThread.attachFiles")}
