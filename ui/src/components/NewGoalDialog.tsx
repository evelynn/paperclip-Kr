...
const levelLabelKeys: Record<string, string> = {
  company: "projectsComp.newGoal.levelCompany",
  team: "projectsComp.newGoal.levelTeam",
  agent: "projectsComp.newGoal.levelAgent",
  task: "projectsComp.newGoal.levelTask",
};
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>{newGoalDefaults.parentId ? t("projectsComp.newGoal.titleSub") : t("projectsComp.newGoal.title")}</span>
          </div>
        ...
        <div className="px-4 pt-4 pb-2 shrink-0">
          <input
            ...
            placeholder={t("projectsComp.newGoal.titlePlaceholder")}
            value={title}
        ...
        <div className="px-4 pb-2 overflow-y-auto max-h-[50vh]">
          <MarkdownEditor
            ...
            placeholder={t("projectsComp.newGoal.descriptionPlaceholder")}
            bordered={false}
          ...
          <Popover open={parentOpen} onOpenChange={setParentOpen}>
            <PopoverTrigger asChild>
              <button className="inline-flex items-center gap-1.5 rounded-md border border-border px-2 py-1 text-xs hover:bg-accent/50 transition-colors">
                ...
                {currentParent ? currentParent.title : t("projectsComp.newGoal.parentGoal")}
              </button>
            </PopoverTrigger>
            <PopoverContent className="w-48 p-1" align="start">
              ...
              >
                {t("projectsComp.newGoal.noParent")}
              </button>
              {(goals ?? []).map((g) => (
                <button
                  key={g.id}
        ...
        <div className="flex items-center justify-end px-4 py-2.5 border-t border-border">
          ...
          >
            {createGoal.isPending ? t("projectsComp.newGoal.creating") : newGoalDefaults.parentId ? t("projectsComp.newGoal.createSub") : t("projectsComp.newGoal.create")}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
