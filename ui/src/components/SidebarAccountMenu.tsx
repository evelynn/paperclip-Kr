...
export function SidebarAccountMenu({
  ...
  const secondaryLabel =
    ...
    (deploymentMode === "authenticated"
      ? t("account.secondary.signedIn", { defaultValue: "Signed in" })
      : t("account.secondary.localBoard", { defaultValue: "Local workspace board" }));
  const accountBadge =
    deploymentMode === "authenticated"
      ? t("account.badge.account", { defaultValue: "Account" })
      : t("account.badge.local", { defaultValue: "Local" });
        ...
        >
          ...
          <div className="-mt-8 px-4 pb-4">
              ...
              <div className="min-w-0 flex-1 pt-1">
                ...
                {version ? (
                  <p className="mt-1 text-xs text-muted-foreground">
                    {t("account.version", { version, defaultValue: "Paperclip v{{version}}" })}
                  </p>
                ) : null}
              </div>
            </div>
            ...
            <div className="mt-4 space-y-1">
              <MenuAction
                label={t("account.viewProfile.label", { defaultValue: "View profile" })}
              ...
              />
              <MenuAction
                label={t("account.editProfile.label", { defaultValue: "Edit profile" })}
              ...
              />
              <MenuAction
                label={t("account.documentation.label", { defaultValue: "Documentation" })}
              ...
              />
              <MenuAction
                label={t("account.feedback.label", { defaultValue: "Feedback" })}
                  ...
                  <span className="min-w-0 flex-1">
                    <span className="block text-sm font-medium text-foreground">
                      {signOutMutation.isPending
                        ? t("account.signOut.labelPending", { defaultValue: "Signing out..." })
                        : t("account.signOut.label", { defaultValue: "Sign out" })}
                    </span>
                    <span className="block text-xs text-muted-foreground">
                      {t("account.signOut.description", { defaultValue: "End this browser session." })}
                    </span>
                  </span>
                </button>
              ) : null}
