  ...
  return (
    <div className="mx-auto max-w-xl py-10">
      <div className="rounded-lg border border-border bg-card p-6">
        <h1 className="text-xl font-semibold">{t("chrome.cloudAccess.noAccessTitle")}</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          {t("chrome.cloudAccess.noAccessBody1")}
        </p>
        <p className="mt-2 text-sm text-muted-foreground">
          {t("chrome.cloudAccess.noAccessBody2")}
        </p>
      </div>
    </div>
  );
...
export function CloudAccessGate() {
  ...
  if (
    ...
    return <div className="mx-auto max-w-xl py-10 text-sm text-muted-foreground">{t("chrome.cloudAccess.loading")}</div>;
  }
      ...
      <div className="mx-auto max-w-xl py-10 text-sm text-destructive">
        {healthQuery.error instanceof Error
          ...
          : boardAccessQuery.error instanceof Error
            ...
            : t("chrome.cloudAccess.loadFailed")}
      </div>
    );
  }
