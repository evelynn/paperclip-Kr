...
export function NotFoundPage({ scope = "global", requestedPrefix }: NotFoundPageProps) {
  ...
  const title = scope === "invalid_company_prefix" ? t("notFound.title.company") : t("notFound.title.page");
  const description =
    scope === "invalid_company_prefix"
      ? t("notFound.description.company", { prefix: normalizedPrefix ?? t("notFound.unknownPrefix") })
