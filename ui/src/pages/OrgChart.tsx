...
export function OrgChart() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("org.chart.breadcrumb") }]);
  }, [setBreadcrumbs, t]);
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={Network} message={t("org.chart.selectCompany")} />;
  }
  ...
  if (orgTree && orgTree.length === 0) {
    return <EmptyState icon={Network} message={t("org.chart.empty")} />;
  }
      ...
      >
        ...
        <div className="absolute top-3 right-3 z-10 flex flex-col gap-1.5">
          <button
            ...
            title={t("org.chart.zoomIn")}
            aria-label={t("org.chart.zoomIn")}
          >
          ...
          <button
            ...
            title={t("org.chart.zoomOut")}
            aria-label={t("org.chart.zoomOut")}
          >
          ...
          <button
            ...
            onClick={fitToScreen}
            title={t("org.chart.fitToScreen")}
            aria-label={t("org.chart.fitChartToScreen")}
          >
