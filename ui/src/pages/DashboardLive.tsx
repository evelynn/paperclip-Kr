...
export function DashboardLive() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      { label: t("dashboard.live.dashboard"), href: "/dashboard" },
  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="text-sm text-muted-foreground">{t("dashboard.live.showingUpTo", { count: DASHBOARD_LIVE_RUN_LIMIT })}</div>
      </div>

      <ActiveAgentsPanel
        companyId={selectedCompanyId}
        title={t("dashboard.live.panelTitle")}
        ...
        emptyMessage={t("dashboard.live.empty")}
