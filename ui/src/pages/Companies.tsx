            ...
            >
              ...
              <div className="flex items-center gap-3 sm:gap-5 mt-4 text-sm text-muted-foreground flex-wrap">
                <div className="flex items-center gap-1.5">
                  ...
                  <span>
                    {t(agentCount === 1 ? "companies.stats.agentCountOne" : "companies.stats.agentCountOther", { count: agentCount })}
                  </span>
                </div>
                <div className="flex items-center gap-1.5">
                  <CircleDot className="h-3.5 w-3.5" />
                  <span>
                    {t(issueCount === 1 ? "companies.stats.taskCountOne" : "companies.stats.taskCountOther", { count: issueCount })}
                  </span>
                </div>
                <div className="flex items-center gap-1.5 tabular-nums">
                  ...
                  <span>
                    ...
                    {company.budgetMonthlyCents > 0
                      ...
                      : <span className="text-xs ml-1">{t("companies.stats.unlimitedBudget")}</span>}
                  </span>
                </div>
                ...
                >
                  ...
                  <div className="flex items-center gap-2 ml-4 shrink-0">
                    ...
                    <Button
                      ...
                      disabled={deleteMutation.isPending}
                    >
                      {deleteMutation.isPending ? t("companies.delete.deleting") : t("companies.delete.delete")}
                    </Button>
                  </div>
                </div>
              )}
